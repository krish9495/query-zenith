...
export const Header = ({ user, onSignOut }: HeaderProps) => {
  return (
    <header className="sticky top-0 z-50 w-full glass-card border-b backdrop-blur-xl">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold gradient-text">LexiQuery</h1>
                <p className="text-xs text-muted-foreground">Enterprise AI Document Intelligence</p>
              </div>
            </div>
          </div>
